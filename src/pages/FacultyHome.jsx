...
/* ---------------------------------------------------
   Data Card Component
--------------------------------------------------- */
function DataCard({ title, children, viewAllLink, icon: Icon }) {
  return (
...
export default function FacultyHome() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      /* -------- Class Sessions -------- */
      if (classSessionsRes) {
        const sessions = classSessionsRes?.data || [];
  ...
  const handleQuickAction = (action) => {
    switch (action) {
      case 'mark-attendance':
        ...
        break;
      case 'add-progress':
        window.location.hash = '#/daily-progress/new';
        break;
      case 'view-timetable':
            ...
            <DataCard title="Quick Actions">
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-purple-800">Timetable</span>
                </button>
                <button
